...
class Transaction(object):
    ...
    we are intertested in. Note, this does not store all the details of a
...
class Amount_Settled(object):
    ...
    def update(self, transact):
        """
        Add new transaction amount to the incoming/outgoing value based on type
        """
...
def daily_transaction_report(trans_dict):
    """ Generating daily transaction report from trans_dict """
...
def entity_ranking_report(trans_dict, type):
    """ Generating entity ranking report from trans_dict.
    value of type can be "incoming" / "outgoing"
    """
